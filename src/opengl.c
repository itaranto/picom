...
bool glx_init_rounded_corners(session_t *ps) {
...

	{
		...
		static const char *FRAG_SHADER_PREFIX =
		    ...
		    "\n"
		    "// from "
		    "http://www.iquilezles.org/www/articles/distfunctions/"
		    "distfunctions.htm\n"
		...
		static const char *FRAG_SHADER_ROUND_CORNERS =
		    ...
		    "\n"
		    "  // compute box\n"
		    "  float b = udRoundBox( gl_FragCoord.xy - halfRes, halfRes, "
		    "u_radius );\n"
		    "\n"
		    "  // colorize (red / black )\n"
		    "  vec3 c = mix( vec3(1.0,0.0,0.0), vec3(0.0,1.0,0.0), "
...
bool glx_round_corners_dst(session_t *ps attr_unused, int dx, int dy, int width, int height,
                           float z attr_unused, GLfloat factor_center attr_unused,
