...
bool glx_render(session_t *ps, const struct managed_win *w, const glx_texture_t *ptex,
                int x, int y, int dx, int dy, int width, int height, int z,
                double opacity, bool argb, bool neg, int cr, const region_t *reg_tgt,
...
bool glx_round_corners_dst(session_t *ps, const glx_texture_t *ptex, int dx, int dy,
                           int width, int height, float z, float cr, GLfloat factor_center,
